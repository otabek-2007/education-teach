        ...
        <div class="row g-5">
            <div class="col-md-6 col-lg-4 col-xl-3">
                <div class="footer-item">
                    <img src="{{ asset('./img/logo.png') }}" height="150px" alt="Site Logo">
            ...
            <div class="col-md-6 col-lg-4 col-xl-3">
                <div class="footer-item">
                    ...
                    <div class="d-flex flex-column align-items-start">
                        <a href="" class="text-body mb-4"><i class="fa fa-map-marker-alt text-primary me-2"></i> {{ $settings->location }}</a>
                        <a href="" class="text-start rounded-0 text-body mb-4"><i class="fa fa-phone-alt text-primary me-2"></i> + {{ $settings->phone }}</a>
                        <a href="" class="text-start rounded-0 text-body mb-4"><i class="fas fa-envelope text-primary me-2"></i> {{ $settings->email }}</a>
